...
| 주차 | 주제 | 주요 내용 |
| --- | --- | --- |
| [1주차](week01-c-mobilenetv2/) | C 언어와 MobileNetV2 | C 기초, 포인터/함수, 2D convolution, pooling, BMP 처리, MobileNetV2 Layer 8 |
| [2주차](week02-verilog-basics/) | Verilog 기본 | 조합·순차논리, 카운터, FSM, 시계/타이머, UART 기초 |
| [3주차](week03-fpga-and-amba/) | FPGA와 AMBA 버스 | 메모리 RTL, AHB/APB, GPIO, ZedBoard 및 ARM 연동 |
| [4주차](week04-axi/) | AXI4-Lite와 UART | AXI4-Lite 메모리, AXI 변환기, UART IP, ZedBoard 연동 |
